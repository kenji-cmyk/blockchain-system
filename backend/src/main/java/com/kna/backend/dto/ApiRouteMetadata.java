...
public final class ApiRouteMetadata {
    ...
    private static final List<ApiRoute> LEGACY_ROUTES = List.of(
            ...
            new ApiRoute("get", "/api/chain/consensus", "View consensus policy settings"),
            new ApiRoute("put", "/api/chain/consensus", "Update consensus policy settings"),
            new ApiRoute("get", "/api/chain/branches", "View consensus branch decisions"),
