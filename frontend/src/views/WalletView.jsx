...
import { EmptyState, GlassPanel, LabeledInput } from "../components/ui/index.js";
import { api } from "../lib/api.js";
import { formatNumber } from "../lib/format.js";

function WalletView({ wallets, setWallets, createWallet, runAction, busy }) {
            ...
            wallets.map((wallet, index) => (
              <article key={wallet.publicKey} className="rounded-xl border border-white/10 bg-void/45 p-4">
                <div className="mb-3 flex items-start justify-between gap-3">
                  <div>
                    <h3 className="font-bold text-white">{wallet.label}</h3>
